...
<div class="container content  mt-3">
    ...
    <form action="{{ route('user.bank-account.store',$userData->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-5 mt-3">
            <!-- Bootstrap Card -->
            <div class="card">
                ...
                <div class="card-footer text-end">
                    <a href="{{ route('user.bank-account.index',$userData->id) }}" class="btn btn-secondary">Kembali</a>
